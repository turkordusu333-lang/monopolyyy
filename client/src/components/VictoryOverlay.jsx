                  ...
                  <div key={p.id} style={{
                    ...
                    <div style={{
                      ...
                      <div style={{ textAlign: 'center' }}>
                        <div style={{ fontSize: '10px', color: '#718096', marginBottom: '2px' }}>Kira</div>
                        <div style={{ fontSize: '12px', fontWeight: 900, color: '#2ECC71' }}>{p.stats?.rentCollected || 0}M</div>
                      </div>
                      <div style={{ textAlign: 'center' }}>
                        <div style={{ fontSize: '10px', color: '#718096', marginBottom: '2px' }}>Kasa</div>
                        <div style={{ fontSize: '12px', fontWeight: 900, color: '#E2E8F0' }}>{p.stats?.totalMoneyBanked || 0}M</div>
                      </div>
                      <div style={{ textAlign: 'center' }}>
                        <div style={{ fontSize: '10px', color: '#718096', marginBottom: '2px' }}>Kart</div>
                        <div style={{ fontSize: '12px', fontWeight: 900, color: '#3498DB' }}>{p.stats?.cardsDrawn || 0}</div>
                      </div>
                      <div style={{ textAlign: 'center' }}>
                        <div style={{ fontSize: '10px', color: '#718096', marginBottom: '2px' }}>Aks.</div>
                        <div style={{ fontSize: '12px', fontWeight: 900, color: '#E74C3C' }}>{p.stats?.actionsPlayed || 0}</div>
                      </div>
                      <div style={{ textAlign: 'center' }}>
                        <div style={{ fontSize: '10px', color: '#718096', marginBottom: '2px' }}>Çalma</div>
                        <div style={{ fontSize: '12px', fontWeight: 900, color: '#F39C12' }}>{p.stats?.stealsPerformed || 0}</div>
                      </div>
                    </div>
                  </div>
                );
